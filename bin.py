...
tgt_train_loader = get_dataloader(data_dir, tgt_train_dir, batch_size, train=True) #데이터 로더랑 classifier 정의 
...
for epoch in range(1, epochs+1):
    for batch_idx, ((src_data, src_label_cl), (tgt_data, tgt_label_cl)) in enumerate(zip(src_train_loader, tgt_train_loader)):
        ...
        src_feature = resnet50_s(src_data)
        tgt_feature = resnet50_t(tgt_data)
